...
* */
public class HandyFinishLcDiaFragment extends DialogFragment implements View.OnClickListener {
    private static final String TAG = "HandyFinishLcDiaFragment";
    ...
    public HandyFinishLcDiaFragment() {
        // Required empty public constructor
    }

    public static HandyFinishLcDiaFragment newInstance(int finishAmount, int wrongAmount, int restSeconds) {
        HandyFinishLcDiaFragment fragment = new HandyFinishLcDiaFragment();

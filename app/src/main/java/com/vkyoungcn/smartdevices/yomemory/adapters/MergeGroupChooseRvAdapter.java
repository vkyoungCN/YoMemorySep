 ...
 * */
public class MergeGroupChooseRvAdapter extends RecyclerView.Adapter<MergeGroupChooseRvAdapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        private final CheckBox ckb_chose;
        private final TextView tv_groupId;
        private final TextView tv_groupNum;
...
//            fgsList = itemView.findViewById(R.id.fragmentGroupsList);
    ...
    public MergeGroupChooseRvAdapter(List<RvMission> missions, Context context) {
        this.missions = missions;
        this.context = context;
    }

    @Override
    public MergeGroupChooseRvAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
